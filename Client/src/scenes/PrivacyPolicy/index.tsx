...
export const PrivacyPolicy = () => {
  return (
    <div className={styles.pageWrapper}>
      <h1>Privacy Policy for WishYou</h1>

      <p>
        At WishYou, accessible from https://www.wishyou.best/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by WishYou and
        how we use it.
      </p>
      ...
      <p>
        ...
        and/or collect in WishYou. This policy is not applicable to any information
      ...
      <p>
        WishYou follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, WishYou uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of WishYou.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective advertisements
        and links that appear on WishYou, which are sent directly to users' browser.
      ...
      <p>
        Note that WishYou has no access to or control over these cookies that are
      ...
      <p>
        WishYou's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        WishYou does not knowingly collect any Personal Identifiable Information from
